...
%% Replace with camera names
% handles.vid1 = %eye camera1
% handles.vid2 = %eye camera2
% handles.vid3 = %field camera
% handles.vid5 = %putter camera
    ...
    function setmapa2(~,~)
        ...
        function mypreview_fcn2(~,~,handleToImageInAxes1)
            ...
            if getGlobalFieldc==1 && getGlobalBttnfc==1
                ...
                desemp=getGlobalDesemp;

                cd dd
                z=1;
                finddd=dir;
                while z<=length(finddd)
                    if finddd(z).isdir==0
                        PL=finddd(z).name;
                    end
                    z=z+1;
                ...
                PL=str2num(PL);
                movefile(num2str(PL),['C:\dados\dd\',num2str(desemp)])
                cd ..
            ...
            if getGlobalW8t==1
                ...
                PL=str2num(PL);
                movefile(num2str(PL),['C:\dados\tt\',num2str(tt)])
                cd ..
            ...
            if getGlobalRECORDpup==3 
                ...
                pupila=handles.Dpup30; pupila(pupila==0)=[]; pupila=mean(pupila);
                cd pupil
                z=1;
                finddd=dir;
                while z<=length(finddd)
                ...
                PL=str2num(PL);
                movefile(num2str(PL),['C:\dados\pupil\',num2str(pupila)])
                cd ..
